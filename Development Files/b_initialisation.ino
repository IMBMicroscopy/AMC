...
String serialNumber = "03";     //Hardware Serial number
#define board           1        // 0=Uno&Leonardo (), 1=Leonardo1 (S/N 003,007,008), 2 = Leonardo2, 3=Beetle (USB02 versions including S/N 014...), 4=Uno (S/N 005)
