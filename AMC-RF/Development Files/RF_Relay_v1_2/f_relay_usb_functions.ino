...
void setFlags(){
  if (stringComplete){
    ...
    if(inputString == "ID?" && Serial) {
    ...
    else if(inputString == "turnAllOff") {
      transmitSignal(remote.allOff);
      delay(500);
    }
    else if(inputString == "toggle1") {
      transmitSignal(remote.lamp); 
      delay(500);
    }
    else if(inputString == "toggle2") {
      transmitSignal(remote.acc[0]); 
      delay(500);
    }
    else if(inputString == "toggle3") {
      transmitSignal(remote.acc[1]); 
      delay(500);
    }
    else if(inputString == "toggle4") {
      transmitSignal(remote.acc[2]); 
      delay(500);
    }
    else if(inputString == "getTime") {
      String values1 = "T=" + String(runTime/1000) +"s, " + String(runTime) + "ms" + ", onT=" + String(onTime()) +"ms" + ", sT=" + String(startTime) + ", rT=" + String(relStartTime);
      ...
      //print pin values
      Serial.println("Board=" + boardType + ": " + "RFpin=" + String(RFpin) + ", " + "lampPin=" + String(lampPin) + ", " + "powerPin=" + String(powerPin) + ", " + "beepPin=" + String(beepPin) + ", " + "lampLED=" + String(lampLED) + ", " + "powerLED=" + String(powerLED) + ", " + "coolLED=" + String(coolLED));
    }
    else {
      newCommand = false;
...
void printCommands() {
  ...
  Serial.println(F("toggle# = toggle on/off a specific outlet, ie: toggle1"));
  Serial.println(F("turnAllOff = turn off all of the relays"));
