void readEEPROM() {
  ...
  updateFlag = constrain(eepromValues[9], false, true); programFlag = constrain(eepromValues[10], false, true); baseCode =constrain(eepromValues[11],1,50);
...
// set default values in new arduino board if the program flag != 1  
 if(eepromValues[10] != 1) {  
   long eepromDefaults[] = {300, 900, 5400, 15, 300, 1800, 20, 500, 0, 0, 1, 1};
   for(int i=0; i<=11; i++) { 
